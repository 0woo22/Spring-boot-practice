...
import com.github.springprac.respository.airlineTicket.AirlineTicketAndFlightInfo;
import com.github.springprac.respository.airlineTicket.AirlineTicketRepository;
import com.github.springprac.respository.passenger.Passenger;
import com.github.springprac.respository.passenger.PassengerRepository;
import com.github.springprac.respository.payments.Payment;
import com.github.springprac.respository.payments.PaymentRepository;
import com.github.springprac.respository.reservations.Reservation;
import com.github.springprac.respository.reservations.ReservationRepository;
import com.github.springprac.respository.users.UserEntity;
import com.github.springprac.respository.users.UserRepository;
import com.github.springprac.web.dto.airline.PaymentsRequest;
import com.github.springprac.web.dto.airline.ReservationRequest;
import com.github.springprac.web.dto.airline.ReservationResult;
...
public class AirReservationService {
    ...
    public AirReservationService(UserRepository userRepository, AirlineTicketRepository airlineTicketRepository, PassengerRepository passengerReposiotry, ReservationRepository reservationRepository, PaymentRepository paymentRepository) {
    ...
    @Transactional(transactionManager = "tm2")  // save 있으면 트랜잭셔널 해주면 좋음
