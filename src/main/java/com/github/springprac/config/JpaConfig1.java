...
@EnableJpaRepositories(
        basePackages = {"com.github.springprac.respository.items","com.github.springprac.respository.storeSales"},
...
public class JpaConfig1 {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean1(@Qualifier("dataSource1")DataSource dataSource){
        ...
        em.setPackagesToScan("com.github.springprac.respository.items","com.github.springprac.respository.storeSales");
