...
public class AirlineTicketJdbcTemplateDao implements AirlineTicketRepository{
    ...
    static RowMapper<AirlineTicketAndFlightInfo> airlineTicketAndFlightInfoRowMapper
            = (((rs, rowNum) ->
            new AirlineTicketAndFlightInfo( // flight , airline ticket 조인
    ...
    @Override
    public List<AirlineTicketAndFlightInfo> findAllAirLineTicketAndFlightInfo(Integer airlineTicketId) { // 조인
